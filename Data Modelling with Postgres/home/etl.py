...
def process_song_file(cur, filepath):
    ...
    filepath:df:pd.read_json(filepath, lines=True)the path to the song file .json (string).
    """
    # open song file
...
def process_data(cur, conn, filepath, func):
    """Gathers .json files from a directory and processes them using the given function.
